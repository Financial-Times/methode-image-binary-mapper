...
public class MethodeImageBinaryMapperApplicationSetupTest {
    ...
    public static DropwizardAppRule<MethodeImageBinaryMapperConfiguration> appRule =
            new DropwizardAppRule<>(MethodeImageBinaryMapperApplication.class, CONFIG_FILE);
    ...
    public void testBuildInfoResourceIsRegisteredAndWorking() {
        ...
        assertThat(buildInfo, hasEntry("artifact.id", "methode-image-binary-mapper"));
    }
}
